...
trainingFeatures1 = extractFeaturesHistBox(I1, trainingPoints1);
trainingFeatures2 = extractFeaturesHistBox(I2, trainingPoints2);
trainingFeatures3 = extractFeaturesHistBox(I3, trainingPoints3);
...
nonFeatures1 = extractFeaturesHistBox(I1, nonFeatureEdges1);
nonFeatures2 = extractFeaturesHistBox(I2, nonFeatureEdges2);
nonFeatures3 = extractFeaturesHistBox(I3, nonFeatureEdges3);
